...
// ── SplitText — each character animates in with a 3-D flip ───────────────────
function SplitText({ text, className, delay = 0, stagger = 50 }) {
  return (
...
// ── Typewriter ────────────────────────────────────────────────────────────────
function useTypewriter(text, speed = 50, delay = 1300) {
...
const skillCategories = [
  {
    ...
    borderClass: "border-purple-500/25 hover:border-purple-400/55 hover:shadow-[0_0_28px_rgba(168,85,247,0.12)]",
  ...
  },
  {
    ...
    borderClass: "border-cyan-500/25 hover:border-cyan-400/55 hover:shadow-[0_0_28px_rgba(0,212,255,0.12)]",
  ...
  },
  {
    ...
    borderClass: "border-emerald-500/25 hover:border-emerald-400/55 hover:shadow-[0_0_28px_rgba(16,185,129,0.12)]",
...
const projects = [
  {
    ...
    description: "A full-featured social platform for alumni — real-time posts, comments, authentication, search, and profile editing. React Native frontend with Firebase as the entire backend.",
    tech: ["React Native", "Firebase", "Auth", "Realtime DB"],
    videoId: "F2YT74ygsXc",
    gradientBg: "from-cyan-900/20 to-blue-900/20",
    hoverBorder: "hover:border-cyan-500/45 hover:shadow-[0_0_30px_rgba(6,182,212,0.14)]",
  },
  {
    title: "Housing Price Predictor",
    badge: "ML Project",
    badgeClass: "bg-purple-500/15 text-purple-400 border border-purple-500/30",
    description: "Trained regression models on the Boston Housing dataset to predict property prices. Deep EDA, feature engineering, and model evaluation with NumPy, Pandas, and Scikit-learn.",
    tech: ["Python", "NumPy", "Pandas", "Scikit-learn", "Regression"],
    videoId: "ttNy2XOnuqA",
    gradientBg: "from-purple-900/20 to-pink-900/20",
    hoverBorder: "hover:border-purple-500/45 hover:shadow-[0_0_30px_rgba(168,85,247,0.14)]",
  },
  {
    title: "AI Portfolio Assistant",
    badge: "Live on this site",
    badgeClass: "bg-emerald-500/15 text-emerald-400 border border-emerald-500/30",
    description: "A GPT-powered conversational AI built directly into this portfolio. It knows everything about my projects and skills. Try it — it's live in the bottom-right corner right now.",
    tech: ["OpenAI API", "GPT-3.5", "Next.js", "React"],
    isLive: true,
    gradientBg: "from-emerald-900/20 to-teal-900/20",
    hoverBorder: "hover:border-emerald-500/45 hover:shadow-[0_0_30px_rgba(16,185,129,0.14)]",
  },
];
...
export default function Home() {
  ...
  // ── Dual cursor (dot snaps, ring lags via rAF) ───────────────────────────
  useEffect(() => {
    const dot  = dotRef.current;
    const ring = ringRef.current;
    if (!dot || !ring) return;

    let mx = -300, my = -300, rx = -300, ry = -300, rafId;
  ...
  // ── Scroll reveal ────────────────────────────────────────────────────────
  useEffect(() => {
    const els = document.querySelectorAll(".reveal-up, .reveal-scale, .line-reveal");
  ...
  const handleCard = useCallback((e) => {
    ...
    el.style.transform = `perspective(900px) rotateX(${-ry * 8}deg) rotateY(${rx * 8}deg) translateY(-5px)`;
  }, []);
  ...
  return (
    <div className="min-h-screen bg-black text-slate-300">
      ...
      {/* ── Nav ── */}
      <header
        className="fixed top-0 left-0 w-full z-50 border-b border-white/[0.045]"
        style={{ background: "rgba(0,0,0,0.78)", backdropFilter: "blur(22px)" }}
      >
        <nav className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <span className="gradient-text font-bold text-xl tracking-tight logo-glow select-none">SV</span>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto w-full flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div
              className="inline-flex items-center gap-2 mb-7 px-3 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-medium"
            ...
            {/* Cinematic large heading with per-character animation */}
            <h1
              className="font-extrabold text-white leading-[0.88] mb-5 tracking-[-0.04em]"
              style={{ fontSize: "clamp(3.5rem, 9.5vw, 8.5rem)" }}
            >
              <div className="overflow-hidden pb-[0.1em]">
                <SplitText text="Sarthak" delay={200} stagger={55} className="block" />
              </div>
              <div className="overflow-hidden pb-[0.1em]">
                <span
                  className="gradient-text block char"
            ...
            {/* Typewriter subtitle */}
            <p
              className="text-base lg:text-lg text-slate-400 mb-3 font-medium min-h-[1.75rem]"
            ...
            <p
              className="text-slate-500 max-w-md mx-auto lg:mx-0 mb-8 leading-relaxed text-sm"
              style={{ animation: "fadeInUp 0.5s ease 1.65s both" }}
            >
            ...
            <div
              ...
              style={{ animation: "fadeInUp 0.5s ease 1.8s both" }}
            >
              <a
                href="https://www.linkedin.com/in/sarthak-vashistha/"
                target="_blank"
              ...
              >
                <AiFillLinkedin size={17} /> Let&apos;s Connect
              </a>
              <a
            ...
            <div
              className="flex gap-5 justify-center lg:justify-start text-slate-600 text-2xl"
          ...
          <div
            ...
            style={{ animation: "fadeIn 0.9s ease 0.4s both" }}
          >
            <div
            ...
            <div className="absolute -inset-6 rounded-full spin-slow"
              style={{ border: "1px dashed rgba(168,85,247,0.22)" }} />
            <div className="absolute -inset-11 rounded-full"
              style={{ border: "1px solid rgba(0,212,255,0.07)", animation: "spin-slow 35s linear infinite reverse" }} />

            <div className="absolute -bottom-3 -right-3 bg-black/85 backdrop-blur-xl border border-cyan-500/25 rounded-xl px-3 py-2 flex items-center gap-2 shadow-2xl">
      ...
      <div className="px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="line-reveal" style={{ background: "linear-gradient(to right, transparent, rgba(255,255,255,0.08), transparent)" }} />
        </div>
      </div>
      ...
      <section id="skills" className="py-28 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 reveal-up">
            <p className="text-[11px] font-bold tracking-[0.28em] text-cyan-500 uppercase mb-4">Expertise</p>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {skillCategories.map((cat, i) => (
              <div
                key={cat.name}
                className={`glow-card anim-border spotlight-card rounded-2xl p-7 border transition-all duration-150 ${cat.borderClass} reveal-scale`}
                style={{ transitionDelay: `${i * 100}ms` }}
                onMouseMove={handleCard}
                onMouseLeave={handleCardLeave}
              >
                <div className={`mb-4 ${cat.colorClass}`}>{cat.icon}</div>
                <h3 className={`text-sm font-semibold mb-5 tracking-wide ${cat.colorClass}`}>{cat.name}</h3>
                <div className="flex flex-wrap gap-2 stagger">
                  {cat.skills.map((skill) => (
                    <span key={skill} className="skill-badge text-xs px-3 py-1 rounded-full">{skill}</span>
                  ))}
                </div>
              </div>
            ))}
      ...
      <div className="px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="line-reveal" style={{ background: "linear-gradient(to right, transparent, rgba(168,85,247,0.14), transparent)" }} />
        </div>
      </div>
      ...
      <section id="projects" className="py-28 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 reveal-up">
            <p className="text-[11px] font-bold tracking-[0.28em] text-purple-500 uppercase mb-4">Portfolio</p>
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4 tracking-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project, i) => (
              <div
                key={project.title}
                className={`glow-card anim-border spotlight-card rounded-2xl overflow-hidden border border-white/[0.05] transition-all duration-150 bg-gradient-to-br ${project.gradientBg} ${project.hoverBorder} reveal-up`}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-white font-semibold text-lg mb-2 leading-snug tracking-tight">{project.title}</h3>
                  <p className="text-slate-400 text-sm leading-relaxed mb-4">{project.description}</p>
                  <div className="flex flex-wrap gap-1.5">
                    {project.tech.map((t) => (
                      <span key={t} className="skill-badge text-xs px-2.5 py-0.5 rounded-md">{t}</span>
                    ))}
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(0,212,255,0.04) 0%, rgba(168,85,247,0.04) 50%, rgba(16,185,129,0.04) 100%)",
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex justify-center mb-6">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500 to-purple-600 flex items-center justify-center shadow-[0_0_30px_rgba(0,212,255,0.28)]">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <a
                  ...
                  className="btn-primary text-white px-6 py-3 rounded-xl font-semibold text-sm flex items-center gap-2"
                >
                  <AiFillLinkedin size={17} /> Connect on LinkedIn
                </a>
                <a
      ...
      <footer className="py-12 px-6 border-t border-white/[0.04] relative z-10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-5 text-slate-600 text-xl">
            <a href="https://www.linkedin.com/in/sarthak-vashistha/" target="_blank" rel="noopener noreferrer"
              className="hover:text-cyan-400 transition-colors hover:drop-shadow-[0_0_8px_rgba(0,212,255,0.8)]"><AiFillLinkedin /></a>
            <a href="https://github.com/Insitium" target="_blank" rel="noopener noreferrer"
              className="hover:text-cyan-400 transition-colors hover:drop-shadow-[0_0_8px_rgba(0,212,255,0.8)]"><AiFillGithub /></a>
            <a href="https://www.youtube.com/@sarthakvashistha6290/videos" target="_blank" rel="noopener noreferrer"
              className="hover:text-red-400 transition-colors hover:drop-shadow-[0_0_8px_rgba(248,113,113,0.8)]"><AiFillYoutube /></a>
          </div>
